...
namespace MyLittleRPG.Services
{
    public class QuestService : BackgroundService
    {
        ...
        private async Task CreateQuest(MonsterContext context, CancellationToken ct, Personnage personnage)
        {
            ...
            {
                case 1:
                    QueteNiveauAtteint queteNiveau = new QueteNiveauAtteint(personnage.Niveau + rnd.Next(1, 3), personnage.Id, personnage.Niveau);
                ...
                case 3:
                    ...
                    QueteVisiterTuile queteTuile = new QueteVisiterTuile(tileRandom.X, tileRandom.Y,tileRandom.X-personnage.X,tileRandom.Y-personnage.Y, tileRandom.Type, personnage.Id);
